...
#ifndef __TEMPLATE_ENGINE_VERSION_HPP_
#define __TEMPLATE_ENGINE_VERSION_HPP_
...
extern template_engine::SemanticVersion Version;


#endif // !__TEMPLATE_ENGINE_VERSION_HPP_
